...
Ko'p merosda `super()` qaysi tartibda ishlaydi?



- [A] Istalgan tartibda 
- [B] MRO (Method Resolution Order) — soldan o'nga tartibda 
- [C] Oxirgi ota classdan boshlab 
- [D] Alfavit tartibida 


> **To'g'ri javob:** B 
> **Tushuntirish:** Python MRO (C3 linearization) bo'yicha ishlaydi. `class C(A, B):` → A avval, B keyin.
